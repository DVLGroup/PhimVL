;(function($) {
  $.fn.quicksearch = function(options) {
    ...
    options = jQuery.extend({
      ...
      labelClass: 'qs_label text-muted',
      inputText: null,
      inputClass: 'qs_input form-control',
      loaderId: 'loader',
      loaderClass: 'loader',
      loaderImg: null,
      loaderText: 'Loading...',
    ...
    function make_form() {
      return '<hr/><div ' + 'id="' + options.formId + '" ' + 'class="quicksearch">' +
    ...
    function make_form_input() {
      ...
      return '<input type="text" value="' + val + '"placeholder="Nhập Nội Dung Tìm Kiếm..."width=200 rel="' + options.randomElement + '" class="' + options.inputClass + '" id="' + options.randomElement + '" /> ';
    }
