...
if (!isset($_REQUEST['filmLeTranID']) || !isset($_REQUEST['filmLeTranName']) ||!isset($_REQUEST['linkPhim']) || !isset($_REQUEST['tenFilmLeVi']) || !isset($_REQUEST['namSX']) || !isset($_REQUEST['theLoai1']) || !isset($_REQUEST['theLoai2']) || !isset($_REQUEST['theLoai3']) || !isset($_REQUEST['nuocSX']) || !isset($_REQUEST['nhaSX']) || !isset($_REQUEST['noiDung']) || !isset($_REQUEST['avatar']) || !isset($_REQUEST['cover']) || !isset($_REQUEST['tenDaoDien']) || !isset($_REQUEST['tenDienVien'])) {
	...
	`film_le_avatar`='".$_REQUEST['avatar']."',`film_le_cover`='".$_REQUEST['cover']."',`film_le_daodien`='".$_REQUEST['tenDaoDien']."',
